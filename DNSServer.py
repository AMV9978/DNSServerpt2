...
# Keep TXT payloads as BYTES to avoid any text parsing issues
dns_records = {
    'example.com.': {
    ...
    # Assignment-required A records + nyu.edu extras
    ...
    'nyu.edu.': {
        ...
        dns.rdatatype.TXT: (encrypted_value,),  # BYTES, not decoded
        ...
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    # Construct TXT using a SINGLE bytes chunk; this preserves the token precisely.
