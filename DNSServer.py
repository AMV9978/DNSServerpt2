...
def _quote_txt_if_needed(s: str) -> str:
    # Ensure TXT RDATA is a single quoted chunk; Fernet tokens contain '=' and must be preserved byte-for-byte
...
# decrypted_value = decrypt_with_aes(encrypted_value, password, salt)  # not used; keep exfil token untouched  # exfil function
